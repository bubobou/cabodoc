...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);loadScript('/cabodoc/js/groupBy-62b30ac391.min.js');loadScript('/cabodoc/js/flexsearch-ad47a5e1ee.min.js',function(){const indexCfg={};const dataUrl="/cabodoc/en.search-data.min.json"
